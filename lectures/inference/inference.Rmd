...
usually use capital letter to denote random sample;
small letter to denote nonrandomness;
```{r}
...
```{r}
Y <- sample( c(-1,35), 10, replace = TRUE, prob=c(37/38, 1/38))
sum(Y)
```
...
# the underlying distribution of y has to be normal to use t distribution
