...
1. Digit reader - categorical (0-9)
2. Movie recommendations - continuous (1-5 stars, but could be sth like 3.4, 4.8)
3. Spam filter - binary/categorical(yes/no)
4. Hospitalizations 
5. Siri - categorical(complicated but still categorical)
